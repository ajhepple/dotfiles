...
" AJH July 2016: Allow Pathogen to be treated as a plugin
...
" Allow mouse selection to activate select mode
set selectmode=mouse

" Files that I am never interested in searching for or searcing in.
" The CtrlP plugin refers to this setting.
set wildignore+=*.class,*.so,*.swp
